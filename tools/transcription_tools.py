...
def _find_binary(binary_name: str) -> Optional[str]:
    ...
    for directory in COMMON_LOCAL_BIN_DIRS:
        ...
        try:
            ...
            # Sandboxes and hardened mounts may deny even stat() on a common
            # prefix. Treat that candidate as unavailable and continue to the
            # remaining prefixes/PATH instead of crashing feature detection.
            continue
