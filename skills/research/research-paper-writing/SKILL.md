...
Keep the main drafting workflow here concise. When the task needs concrete LaTeX implementation examples, load [references/latex-production.md](references/latex-production.md) for:
...
See [references/publication-and-release.md](references/publication-and-release.md) for repository layout, README template, pre-release checklist, anonymous-code guidance, posters, talks, and blog/project-page deliverables.
...
After acceptance, prepare the camera-ready PDF, public code/data, poster, talk or spotlight, blog post, social thread, and project page. See [references/publication-and-release.md](references/publication-and-release.md) for detailed poster/talk/blog guidance and code-release checklists.
...
See [references/sources.md](references/sources.md) for writing philosophy sources, citation APIs, and venue links.
