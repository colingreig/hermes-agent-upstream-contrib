...
| `com.colingreig.hermes.silent-delivery-monitor` | loaded | fresh healthy/breached/alerted/recovered rolling-window result; delivery-aware dedupe | stale result or alert delivery failure |
