...
_REQUIRED_FILES = frozenset({
    ...
    "pr_wake_and_sweep.py", "validate_pr.py", "validator_repo_guard.py", "validator_verdict.py", "verify-hermes-patches.sh",
    ...
    "pr_pipeline/store.py", "pr_pipeline/pipeline_verify.py", "pr_pipeline/validator_repo_guard.py",
})
