...
def test_collect_runtime_readiness_reports_healthy_local_runtime(tmp_path, monkeypatch):
    ...
    # Readiness intentionally degrades when the host volume is >=90% full.
    # Keep this "healthy runtime" case independent of the developer/CI host's
    # current disk pressure; disk-degradation behavior belongs to its own check.
    monkeypatch.setattr(
